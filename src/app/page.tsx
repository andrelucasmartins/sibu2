      ...
      <article className="format lg:format-lg bg-red-900 text-white min-w-full px-8 py-8">
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="flex flex-col justify-center items-center">
            <button
              type="button"
              className="text-white bg-gradient-to-bl from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800  font-medium rounded-lg text-sm px-8 py-3.5 text-center mr-2 mb-2  capitalize"
            >
              <h2 className="text-white m-0 p-0">Comprar Sibutran2</h2>
